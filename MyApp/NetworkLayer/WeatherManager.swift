...
struct WeatherManager {
    ...
    private let mainURL: String = "https://api.openweathermap.org/data/2.5/weather?appid=5366936a1e0b898182073781ca3133e1&units=metric"
    ...
    private func sendRequest(_ urlString: String) {
